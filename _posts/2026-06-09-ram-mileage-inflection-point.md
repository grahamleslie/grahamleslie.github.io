...
## Iteration 1: Shedding the Pendulum
...
## Iteration 2: Finding the "Safe" 34
I landed on the 275/65R20. It’s a 34.1" tire, but crucially, it keeps the stock width. This prevents the tires from rubbing the Upper Control Arms (UCAs) on stock wheels and keeps the "aero" profile as slim as possible.
...
## Iteration 3: Programming the Truth
If you don't calibrate your speedometer, your ECU is operating off bad data. Moving from 33s to 34s means your truck thinks it's going 3.3% slower than it actually is. 
